export const sapHanaServices = [
    {
      id: 1,
      icon: "mdi:database",
      title: "SAP HANA Database",
      description: "SAP HANA Database is a hybrid in-memory database. It is the heart of SAP in-memory technology. In SAP HANA, database tables are of two types: Row Store and Column Store.",
    },
    {
      id: 2,
